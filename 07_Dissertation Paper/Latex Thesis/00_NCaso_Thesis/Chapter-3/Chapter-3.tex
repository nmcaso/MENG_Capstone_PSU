...
\label{chapter3:matlab_code}
    ...
    \twofigures{Results_fig_3.png}{DAS 2D Delay Matrix Performance - Frames per Second}{Results_fig_4.png}{DAS 2D Delay Matrix Performance in Pixels Per Second}{0.7}{fig:orig_das_fps}{fig:orig_das_pps}
