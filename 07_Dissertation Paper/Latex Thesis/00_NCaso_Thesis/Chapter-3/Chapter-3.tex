...
\label{chapter3:matlab_code}
    ...
    \twofigures{Results_fig_3.png}{Performance in Frames per Second}{Results_fig_4.png}{Performance in Pixels Per Second}{0.8}{fig:orig_das_fps}{fig:orig_das_pps}{DAS with 2D Delay Matrix Performance}{fig:orig_das}
...
\label{chapter3:optimized_matlab}
    ...
    \twofigures{Results_fig_1.png}{Speed, Frames per Second}{Results_fig_2.png}{Speed, Pixels Per Second}{0.8}{fig:elem_das_fps}{fig:elem_das_pps}{Elemental DAS Speed in MATLAB}{fig:elem_das}
    ...
    \twofigures{Results_fig_5.png}{Speed, Frames per Second}{Results_fig_6.png}{Speed, Pixels per Second}{0.8}{fig:all_matlab_fps}{fig:all_matlab_pps}{Optimized MATLAB DAS by 3D Delay Matrix}{fig:matlab_das_optimized}
    ...
    \twofigures{Results_fig_7.png}{Speed, Frames per Second}{Results_fig_8.png}{Speed, Pixels per Second}{0.8}{fig:mmult_das_fps}{fig:mmult_das_pps}{MATLAB DAS by Matrix Multiplication}{fig:DAS_mmult}
...
\label{chapter3:parallel_matlab}
    ...
    \twofigures{Results_fig_9.png}{Speed, Frames per Seconds}{Results_fig_10.png}{Speed, Pixels per Second}{0.8}{fig:gpu_matlab_fps}{fig:gpu_matlab_pps}{MATLAB GPU Indexing}{fig:matlab_GPU_indexing}
...
\label{chapter3:compiled_DAS}
    ...
    \twofigures{Results_fig_11.png}{Speed, Frames per Second}{Results_fig_12.png}{Speed, Pixels per Second}{0.8}{fig:compiled_mex_fps}{fig:compiled_mex_pps}{C++ MEX vs MATLAB functions}{fig:CPP_vs_MATLAB}
...
\label{chapter3:CUDA_DAS}
    ...
    \twofigures{Results_fig_13.png}{Speed, Frames per Second}{Results_fig_14.png}{Speed, Pixels per Second}{0.8}{fig:compiled_cuda_fps}{fig:compiled_cuda_pps}{CUDA DAS Performance}{fig:cuda_das}
...
\label{chapter3:Large_Images}
    ...
    \twofigures{Results_fig_15.png}{Time to Complete}{Results_fig_16.png}{Speed in PPS}{0.8}{fig:fr_rot_sec}{fig:fr_rot_pps}{Frame Rotation Performance}{fig:fr_rot_comparison}
    ...
    \twofigures{Results_fig_17.png}{Device Utilization}{Results_fig_18.png}{Utilization vs Imaging Speed}{0.6}{fig:gpu_util}{fig:gpu_util_v_size}{GPU Frame Rotation Device Utilization Plots}{fig:frrot_dvc_utilization}
    ...
    \twofigures{FR_Compare_indexed.png}{Standard DAS}{FR_Compare_rotated.png}{Frame-Rotated DAS}{0.5}{fig:indexed_forcompare}{fig:rot_forcompare}{Image quality comparison between frame rotation and standard calculation}{fig:frrot_imgquality}
